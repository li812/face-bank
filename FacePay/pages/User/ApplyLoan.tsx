    ...
    <SafeAreaView style={{ flex: 1 }} edges={['top', 'left', 'right']}>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.headerContainer}>
          ...
          <Text style={styles.heading}>Apply for Loan</Text>
        </View>
        {loading ? (
          ...
          <View style={styles.formCard}>
            ...
            <View style={styles.pickerWrapper}>
              <Text style={styles.pickerLabel}>Account Number</Text>
              <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{ marginBottom: 8 }}>
                {accounts.map(acc => (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.branchOption,
                      form.account_number == acc.id && styles.branchOptionSelected
                    ]}
            ...
            <TouchableOpacity
              ...
              disabled={submitting}
            >
              <Text style={styles.submitButtonText}>{submitting ? 'Applying...' : 'Apply Loan'}</Text>
            </TouchableOpacity>
